...
class NavigationItemSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['route_name' => 'inventory',                    'label' => 'Dashboard Inventory', 'icon' => 'chart-pie',                  'section' => 'INVENTORY',   'sub_group' => 'Master Data',             'badge_type' => null,                                   'menu_column' => 1, 'sort_order' => 3,  'permission' => 'inventory.view'],
            ...
            ['route_name' => 'inventory.requests',           'label' => 'Permintaan Barang',  'icon' => 'inbox-arrow-down',           'section' => 'INVENTORY',   'sub_group' => 'Transfer & Permintaan',   'badge_type' => 'inventory_request',                    'menu_column' => 2, 'sort_order' => 3,  'permission' => 'inventory.transfer.view'],
            ...
            // COLUMN 3
            ['route_name' => 'inventory.fulfillments',       'label' => 'Pemenuhan Produksi', 'icon' => 'clipboard-document-check',   'section' => 'INVENTORY',   'sub_group' => 'Outbound (Keluar)',       'badge_type' => 'inventory_production_fulfillment',     'menu_column' => 3, 'sort_order' => 1,  'permission' => 'production.order.update'],
            ['route_name' => 'inventory.sales-deliveries',   'label' => 'Pengiriman Penjualan', 'icon' => 'truck',                    'section' => 'INVENTORY',   'sub_group' => 'Outbound (Keluar)',       'badge_type' => 'inventory_sales_delivery',             'menu_column' => 3, 'sort_order' => 2,  'permission' => 'inventory.view'],
            ...
            ['route_name' => 'finance.payables',             'label' => 'Hutang Pembelian',   'icon' => 'credit-card',                'section' => 'KEUANGAN',    'sub_group' => 'Operasional',             'badge_type' => null,                                   'menu_column' => 1, 'sort_order' => 2,  'permission' => null],
            ['route_name' => 'finance.transfers',            'label' => 'Mutasi Internal',    'icon' => 'arrows-right-left',          'section' => 'KEUANGAN',    'sub_group' => 'Operasional',             'badge_type' => 'finance_transfer',                     'menu_column' => 1, 'sort_order' => 3,  'permission' => null],
